...
body = Kubernetes::IoK8sApiAutoscalingV2beta2HorizontalPodAutoscaler.new # IoK8sApiAutoscalingV2beta2HorizontalPodAutoscaler | 
opts = {
...
begin
  ...
  puts "Exception when calling AutoscalingV2beta2Api->create_autoscaling_v2beta2_namespaced_horizontal_pod_autoscaler: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling AutoscalingV2beta2Api->delete_autoscaling_v2beta2_collection_namespaced_horizontal_pod_autoscaler: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling AutoscalingV2beta2Api->delete_autoscaling_v2beta2_namespaced_horizontal_pod_autoscaler: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling AutoscalingV2beta2Api->get_autoscaling_v2beta2_api_resources: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling AutoscalingV2beta2Api->list_autoscaling_v2beta2_horizontal_pod_autoscaler_for_all_namespaces: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling AutoscalingV2beta2Api->list_autoscaling_v2beta2_namespaced_horizontal_pod_autoscaler: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling AutoscalingV2beta2Api->patch_autoscaling_v2beta2_namespaced_horizontal_pod_autoscaler: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling AutoscalingV2beta2Api->patch_autoscaling_v2beta2_namespaced_horizontal_pod_autoscaler_status: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling AutoscalingV2beta2Api->read_autoscaling_v2beta2_namespaced_horizontal_pod_autoscaler: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling AutoscalingV2beta2Api->read_autoscaling_v2beta2_namespaced_horizontal_pod_autoscaler_status: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling AutoscalingV2beta2Api->replace_autoscaling_v2beta2_namespaced_horizontal_pod_autoscaler: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling AutoscalingV2beta2Api->replace_autoscaling_v2beta2_namespaced_horizontal_pod_autoscaler_status: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling AutoscalingV2beta2Api->watch_autoscaling_v2beta2_horizontal_pod_autoscaler_list_for_all_namespaces: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling AutoscalingV2beta2Api->watch_autoscaling_v2beta2_namespaced_horizontal_pod_autoscaler: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling AutoscalingV2beta2Api->watch_autoscaling_v2beta2_namespaced_horizontal_pod_autoscaler_list: #{e}"
end
```
