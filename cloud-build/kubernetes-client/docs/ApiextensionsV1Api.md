...
body = Kubernetes::IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition.new # IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition | 
opts = {
...
begin
  ...
  puts "Exception when calling ApiextensionsV1Api->create_apiextensions_v1_custom_resource_definition: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling ApiextensionsV1Api->delete_apiextensions_v1_collection_custom_resource_definition: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling ApiextensionsV1Api->delete_apiextensions_v1_custom_resource_definition: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling ApiextensionsV1Api->get_apiextensions_v1_api_resources: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling ApiextensionsV1Api->list_apiextensions_v1_custom_resource_definition: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling ApiextensionsV1Api->patch_apiextensions_v1_custom_resource_definition: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling ApiextensionsV1Api->patch_apiextensions_v1_custom_resource_definition_status: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling ApiextensionsV1Api->read_apiextensions_v1_custom_resource_definition: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling ApiextensionsV1Api->read_apiextensions_v1_custom_resource_definition_status: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling ApiextensionsV1Api->replace_apiextensions_v1_custom_resource_definition: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling ApiextensionsV1Api->replace_apiextensions_v1_custom_resource_definition_status: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling ApiextensionsV1Api->watch_apiextensions_v1_custom_resource_definition: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling ApiextensionsV1Api->watch_apiextensions_v1_custom_resource_definition_list: #{e}"
end
```
