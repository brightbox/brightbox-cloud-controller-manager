...
body = Kubernetes::IoK8sApiBatchV1Job.new # IoK8sApiBatchV1Job | 
opts = {
...
begin
  ...
  puts "Exception when calling BatchV1Api->create_batch_v1_namespaced_job: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling BatchV1Api->delete_batch_v1_collection_namespaced_job: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling BatchV1Api->delete_batch_v1_namespaced_job: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling BatchV1Api->get_batch_v1_api_resources: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling BatchV1Api->list_batch_v1_job_for_all_namespaces: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling BatchV1Api->list_batch_v1_namespaced_job: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling BatchV1Api->patch_batch_v1_namespaced_job: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling BatchV1Api->patch_batch_v1_namespaced_job_status: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling BatchV1Api->read_batch_v1_namespaced_job: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling BatchV1Api->read_batch_v1_namespaced_job_status: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling BatchV1Api->replace_batch_v1_namespaced_job: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling BatchV1Api->replace_batch_v1_namespaced_job_status: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling BatchV1Api->watch_batch_v1_job_list_for_all_namespaces: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling BatchV1Api->watch_batch_v1_namespaced_job: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling BatchV1Api->watch_batch_v1_namespaced_job_list: #{e}"
end
```
