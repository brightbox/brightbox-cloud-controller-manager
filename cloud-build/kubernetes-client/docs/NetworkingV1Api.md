...
body = Kubernetes::IoK8sApiNetworkingV1NetworkPolicy.new # IoK8sApiNetworkingV1NetworkPolicy | 
opts = {
...
begin
  ...
  puts "Exception when calling NetworkingV1Api->create_networking_v1_namespaced_network_policy: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling NetworkingV1Api->delete_networking_v1_collection_namespaced_network_policy: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling NetworkingV1Api->delete_networking_v1_namespaced_network_policy: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling NetworkingV1Api->get_networking_v1_api_resources: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling NetworkingV1Api->list_networking_v1_namespaced_network_policy: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling NetworkingV1Api->list_networking_v1_network_policy_for_all_namespaces: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling NetworkingV1Api->patch_networking_v1_namespaced_network_policy: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling NetworkingV1Api->read_networking_v1_namespaced_network_policy: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling NetworkingV1Api->replace_networking_v1_namespaced_network_policy: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling NetworkingV1Api->watch_networking_v1_namespaced_network_policy: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling NetworkingV1Api->watch_networking_v1_namespaced_network_policy_list: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling NetworkingV1Api->watch_networking_v1_network_policy_list_for_all_namespaces: #{e}"
end
```
