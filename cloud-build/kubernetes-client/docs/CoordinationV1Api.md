...
body = Kubernetes::IoK8sApiCoordinationV1Lease.new # IoK8sApiCoordinationV1Lease | 
opts = {
...
begin
  ...
  puts "Exception when calling CoordinationV1Api->create_coordination_v1_namespaced_lease: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling CoordinationV1Api->delete_coordination_v1_collection_namespaced_lease: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling CoordinationV1Api->delete_coordination_v1_namespaced_lease: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling CoordinationV1Api->get_coordination_v1_api_resources: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling CoordinationV1Api->list_coordination_v1_lease_for_all_namespaces: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling CoordinationV1Api->list_coordination_v1_namespaced_lease: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling CoordinationV1Api->patch_coordination_v1_namespaced_lease: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling CoordinationV1Api->read_coordination_v1_namespaced_lease: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling CoordinationV1Api->replace_coordination_v1_namespaced_lease: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling CoordinationV1Api->watch_coordination_v1_lease_list_for_all_namespaces: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling CoordinationV1Api->watch_coordination_v1_namespaced_lease: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling CoordinationV1Api->watch_coordination_v1_namespaced_lease_list: #{e}"
end
```
