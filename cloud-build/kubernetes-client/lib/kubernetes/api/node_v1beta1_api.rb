...
module Kubernetes
  class NodeV1beta1Api
    ...
    # @param body [IoK8sApiNodeV1beta1RuntimeClass] 
    ...
    def create_node_v1beta1_runtime_class(body, opts = {})
      data, _status_code, _headers = create_node_v1beta1_runtime_class_with_http_info(body, opts)
      data
    end
    ...
    # @option opts [String] :dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
    # @option opts [String] :field_manager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
    # @return [Array<(IoK8sApiNodeV1beta1RuntimeClass, Integer, Hash)>] IoK8sApiNodeV1beta1RuntimeClass data, response status code and response headers
    def create_node_v1beta1_runtime_class_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: NodeV1beta1Api.create_node_v1beta1_runtime_class ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling NodeV1beta1Api.create_node_v1beta1_runtime_class"
      end
      # resource path
      local_var_path = '/apis/node.k8s.io/v1beta1/runtimeclasses'
      ...
      # return_type
      return_type = opts[:return_type] || 'IoK8sApiNodeV1beta1RuntimeClass' 
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NodeV1beta1Api#create_node_v1beta1_runtime_class\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def delete_node_v1beta1_collection_runtime_class(opts = {})
      data, _status_code, _headers = delete_node_v1beta1_collection_runtime_class_with_http_info(opts)
      data
    end
    ...
    def delete_node_v1beta1_collection_runtime_class_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: NodeV1beta1Api.delete_node_v1beta1_collection_runtime_class ...'
      end
      # resource path
      local_var_path = '/apis/node.k8s.io/v1beta1/runtimeclasses'
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NodeV1beta1Api#delete_node_v1beta1_collection_runtime_class\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [IoK8sApimachineryPkgApisMetaV1DeleteOptions] :body 
    # @return [IoK8sApimachineryPkgApisMetaV1Status]
    def delete_node_v1beta1_runtime_class(name, opts = {})
      data, _status_code, _headers = delete_node_v1beta1_runtime_class_with_http_info(name, opts)
      data
    end
    ...
    # @option opts [IoK8sApimachineryPkgApisMetaV1DeleteOptions] :body 
    # @return [Array<(IoK8sApimachineryPkgApisMetaV1Status, Integer, Hash)>] IoK8sApimachineryPkgApisMetaV1Status data, response status code and response headers
    def delete_node_v1beta1_runtime_class_with_http_info(name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: NodeV1beta1Api.delete_node_v1beta1_runtime_class ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling NodeV1beta1Api.delete_node_v1beta1_runtime_class"
      end
      # resource path
      local_var_path = '/apis/node.k8s.io/v1beta1/runtimeclasses/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s))
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NodeV1beta1Api#delete_node_v1beta1_runtime_class\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_node_v1beta1_api_resources(opts = {})
      data, _status_code, _headers = get_node_v1beta1_api_resources_with_http_info(opts)
      data
    end
    ...
    def get_node_v1beta1_api_resources_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: NodeV1beta1Api.get_node_v1beta1_api_resources ...'
      end
      # resource path
      local_var_path = '/apis/node.k8s.io/v1beta1/'
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NodeV1beta1Api#get_node_v1beta1_api_resources\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def list_node_v1beta1_runtime_class(opts = {})
      data, _status_code, _headers = list_node_v1beta1_runtime_class_with_http_info(opts)
      data
    end
    ...
    # @option opts [Integer] :timeout_seconds Timeout for the list/watch call. This limits the duration of the call, regardless of any activity or inactivity.
    # @option opts [Boolean] :watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
    # @return [Array<(IoK8sApiNodeV1beta1RuntimeClassList, Integer, Hash)>] IoK8sApiNodeV1beta1RuntimeClassList data, response status code and response headers
    def list_node_v1beta1_runtime_class_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: NodeV1beta1Api.list_node_v1beta1_runtime_class ...'
      end
      # resource path
      local_var_path = '/apis/node.k8s.io/v1beta1/runtimeclasses'
      ...
      # return_type
      return_type = opts[:return_type] || 'IoK8sApiNodeV1beta1RuntimeClassList' 
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NodeV1beta1Api#list_node_v1beta1_runtime_class\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @return [IoK8sApiNodeV1beta1RuntimeClass]
    def patch_node_v1beta1_runtime_class(name, body, opts = {})
      data, _status_code, _headers = patch_node_v1beta1_runtime_class_with_http_info(name, body, opts)
      data
    end
    ...
    # @option opts [Boolean] :force Force is going to \&quot;force\&quot; Apply requests. It means user will re-acquire conflicting fields owned by other people. Force flag must be unset for non-apply patch requests.
    # @return [Array<(IoK8sApiNodeV1beta1RuntimeClass, Integer, Hash)>] IoK8sApiNodeV1beta1RuntimeClass data, response status code and response headers
    def patch_node_v1beta1_runtime_class_with_http_info(name, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: NodeV1beta1Api.patch_node_v1beta1_runtime_class ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling NodeV1beta1Api.patch_node_v1beta1_runtime_class"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling NodeV1beta1Api.patch_node_v1beta1_runtime_class"
      end
      # resource path
      local_var_path = '/apis/node.k8s.io/v1beta1/runtimeclasses/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s))
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NodeV1beta1Api#patch_node_v1beta1_runtime_class\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @return [IoK8sApiNodeV1beta1RuntimeClass]
    def read_node_v1beta1_runtime_class(name, opts = {})
      data, _status_code, _headers = read_node_v1beta1_runtime_class_with_http_info(name, opts)
      data
    end
    ...
    # @option opts [Boolean] :export Should this value be exported.  Export strips fields that a user can not specify. Deprecated. Planned for removal in 1.18.
    # @return [Array<(IoK8sApiNodeV1beta1RuntimeClass, Integer, Hash)>] IoK8sApiNodeV1beta1RuntimeClass data, response status code and response headers
    def read_node_v1beta1_runtime_class_with_http_info(name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: NodeV1beta1Api.read_node_v1beta1_runtime_class ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling NodeV1beta1Api.read_node_v1beta1_runtime_class"
      end
      # resource path
      local_var_path = '/apis/node.k8s.io/v1beta1/runtimeclasses/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s))
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NodeV1beta1Api#read_node_v1beta1_runtime_class\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :field_manager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
    # @return [IoK8sApiNodeV1beta1RuntimeClass]
    def replace_node_v1beta1_runtime_class(name, body, opts = {})
      data, _status_code, _headers = replace_node_v1beta1_runtime_class_with_http_info(name, body, opts)
      data
    end
    ...
    # @option opts [String] :field_manager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
    # @return [Array<(IoK8sApiNodeV1beta1RuntimeClass, Integer, Hash)>] IoK8sApiNodeV1beta1RuntimeClass data, response status code and response headers
    def replace_node_v1beta1_runtime_class_with_http_info(name, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: NodeV1beta1Api.replace_node_v1beta1_runtime_class ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling NodeV1beta1Api.replace_node_v1beta1_runtime_class"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling NodeV1beta1Api.replace_node_v1beta1_runtime_class"
      end
      # resource path
      local_var_path = '/apis/node.k8s.io/v1beta1/runtimeclasses/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s))
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NodeV1beta1Api#replace_node_v1beta1_runtime_class\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def watch_node_v1beta1_runtime_class(name, opts = {})
      data, _status_code, _headers = watch_node_v1beta1_runtime_class_with_http_info(name, opts)
      data
    end
    ...
    def watch_node_v1beta1_runtime_class_with_http_info(name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: NodeV1beta1Api.watch_node_v1beta1_runtime_class ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling NodeV1beta1Api.watch_node_v1beta1_runtime_class"
      end
      # resource path
      local_var_path = '/apis/node.k8s.io/v1beta1/watch/runtimeclasses/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s))
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NodeV1beta1Api#watch_node_v1beta1_runtime_class\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [Boolean] :watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
    # @return [IoK8sApimachineryPkgApisMetaV1WatchEvent]
    def watch_node_v1beta1_runtime_class_list(opts = {})
      data, _status_code, _headers = watch_node_v1beta1_runtime_class_list_with_http_info(opts)
      data
    end
    ...
    # @option opts [Boolean] :watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
    # @return [Array<(IoK8sApimachineryPkgApisMetaV1WatchEvent, Integer, Hash)>] IoK8sApimachineryPkgApisMetaV1WatchEvent data, response status code and response headers
    def watch_node_v1beta1_runtime_class_list_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: NodeV1beta1Api.watch_node_v1beta1_runtime_class_list ...'
      end
      # resource path
      local_var_path = '/apis/node.k8s.io/v1beta1/watch/runtimeclasses'
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NodeV1beta1Api#watch_node_v1beta1_runtime_class_list\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
