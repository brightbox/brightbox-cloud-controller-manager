...
# Unit tests for Kubernetes::IoK8sApiCoreV1SELinuxOptions
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'IoK8sApiCoreV1SELinuxOptions' do
  before do
    # run before each test
    @instance = Kubernetes::IoK8sApiCoreV1SELinuxOptions.new
  end
  ...
  describe 'test an instance of IoK8sApiCoreV1SELinuxOptions' do
    it 'should create an instance of IoK8sApiCoreV1SELinuxOptions' do
      expect(@instance).to be_instance_of(Kubernetes::IoK8sApiCoreV1SELinuxOptions)
    end
  end
