...
# Unit tests for Kubernetes::CertificatesV1beta1Api
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CertificatesV1beta1Api' do
  before do
  ...
  describe 'test an instance of CertificatesV1beta1Api' do
    it 'should create an instance of CertificatesV1beta1Api' do
      expect(@api_instance).to be_instance_of(Kubernetes::CertificatesV1beta1Api)
    end
  end

  # unit tests for create_certificates_v1beta1_certificate_signing_request
  ...
  describe 'create_certificates_v1beta1_certificate_signing_request test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for delete_certificates_v1beta1_certificate_signing_request
  ...
  describe 'delete_certificates_v1beta1_certificate_signing_request test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for delete_certificates_v1beta1_collection_certificate_signing_request
  ...
  # @option opts [IoK8sApimachineryPkgApisMetaV1DeleteOptions] :body 
  # @return [IoK8sApimachineryPkgApisMetaV1Status]
  describe 'delete_certificates_v1beta1_collection_certificate_signing_request test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_certificates_v1beta1_api_resources
  # get available resources
  # @param [Hash] opts the optional parameters
  # @return [IoK8sApimachineryPkgApisMetaV1APIResourceList]
  describe 'get_certificates_v1beta1_api_resources test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for list_certificates_v1beta1_certificate_signing_request
  ...
  describe 'list_certificates_v1beta1_certificate_signing_request test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for patch_certificates_v1beta1_certificate_signing_request
  ...
  # @return [IoK8sApiCertificatesV1beta1CertificateSigningRequest]
  describe 'patch_certificates_v1beta1_certificate_signing_request test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for patch_certificates_v1beta1_certificate_signing_request_status
  ...
  # @option opts [Boolean] :force Force is going to \&quot;force\&quot; Apply requests. It means user will re-acquire conflicting fields owned by other people. Force flag must be unset for non-apply patch requests.
  # @return [IoK8sApiCertificatesV1beta1CertificateSigningRequest]
  describe 'patch_certificates_v1beta1_certificate_signing_request_status test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for read_certificates_v1beta1_certificate_signing_request
  ...
  # @return [IoK8sApiCertificatesV1beta1CertificateSigningRequest]
  describe 'read_certificates_v1beta1_certificate_signing_request test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for read_certificates_v1beta1_certificate_signing_request_status
  # read status of the specified CertificateSigningRequest
  # @param name name of the CertificateSigningRequest
  # @param [Hash] opts the optional parameters
  # @option opts [String] :pretty If &#39;true&#39;, then the output is pretty printed.
  # @return [IoK8sApiCertificatesV1beta1CertificateSigningRequest]
  describe 'read_certificates_v1beta1_certificate_signing_request_status test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for replace_certificates_v1beta1_certificate_signing_request
  ...
  # @option opts [String] :field_manager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
  # @return [IoK8sApiCertificatesV1beta1CertificateSigningRequest]
  describe 'replace_certificates_v1beta1_certificate_signing_request test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for replace_certificates_v1beta1_certificate_signing_request_approval
  ...
  # @option opts [String] :pretty If &#39;true&#39;, then the output is pretty printed.
  # @return [IoK8sApiCertificatesV1beta1CertificateSigningRequest]
  describe 'replace_certificates_v1beta1_certificate_signing_request_approval test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for replace_certificates_v1beta1_certificate_signing_request_status
  ...
  # @option opts [String] :field_manager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
  # @return [IoK8sApiCertificatesV1beta1CertificateSigningRequest]
  describe 'replace_certificates_v1beta1_certificate_signing_request_status test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for watch_certificates_v1beta1_certificate_signing_request
  ...
  describe 'watch_certificates_v1beta1_certificate_signing_request test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for watch_certificates_v1beta1_certificate_signing_request_list
  ...
  # @option opts [Boolean] :watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
  # @return [IoK8sApimachineryPkgApisMetaV1WatchEvent]
  describe 'watch_certificates_v1beta1_certificate_signing_request_list test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
