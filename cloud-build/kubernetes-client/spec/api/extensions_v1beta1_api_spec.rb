...
# Unit tests for Kubernetes::ExtensionsV1beta1Api
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ExtensionsV1beta1Api' do
  before do
  ...
  describe 'test an instance of ExtensionsV1beta1Api' do
    it 'should create an instance of ExtensionsV1beta1Api' do
      expect(@api_instance).to be_instance_of(Kubernetes::ExtensionsV1beta1Api)
    end
  end

  # unit tests for create_extensions_v1beta1_namespaced_ingress
  # create an Ingress
  ...
  describe 'create_extensions_v1beta1_namespaced_ingress test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for delete_extensions_v1beta1_collection_namespaced_ingress
  ...
  describe 'delete_extensions_v1beta1_collection_namespaced_ingress test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for delete_extensions_v1beta1_namespaced_ingress
  # delete an Ingress
  ...
  # @option opts [IoK8sApimachineryPkgApisMetaV1DeleteOptions] :body 
  # @return [IoK8sApimachineryPkgApisMetaV1Status]
  describe 'delete_extensions_v1beta1_namespaced_ingress test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_extensions_v1beta1_api_resources
  # get available resources
  # @param [Hash] opts the optional parameters
  # @return [IoK8sApimachineryPkgApisMetaV1APIResourceList]
  describe 'get_extensions_v1beta1_api_resources test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for list_extensions_v1beta1_ingress_for_all_namespaces
  ...
  describe 'list_extensions_v1beta1_ingress_for_all_namespaces test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for list_extensions_v1beta1_namespaced_ingress
  # list or watch objects of kind Ingress
  # @param namespace object name and auth scope, such as for teams and projects
  # @param [Hash] opts the optional parameters
  # @option opts [String] :pretty If &#39;true&#39;, then the output is pretty printed.
  ...
  # @option opts [Boolean] :watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
  # @return [IoK8sApiExtensionsV1beta1IngressList]
  describe 'list_extensions_v1beta1_namespaced_ingress test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for patch_extensions_v1beta1_namespaced_ingress
  ...
  # @return [IoK8sApiExtensionsV1beta1Ingress]
  describe 'patch_extensions_v1beta1_namespaced_ingress test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for patch_extensions_v1beta1_namespaced_ingress_status
  ...
  # @option opts [Boolean] :force Force is going to \&quot;force\&quot; Apply requests. It means user will re-acquire conflicting fields owned by other people. Force flag must be unset for non-apply patch requests.
  # @return [IoK8sApiExtensionsV1beta1Ingress]
  describe 'patch_extensions_v1beta1_namespaced_ingress_status test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for read_extensions_v1beta1_namespaced_ingress
  ...
  # @return [IoK8sApiExtensionsV1beta1Ingress]
  describe 'read_extensions_v1beta1_namespaced_ingress test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for read_extensions_v1beta1_namespaced_ingress_status
  ...
  # @option opts [String] :pretty If &#39;true&#39;, then the output is pretty printed.
  # @return [IoK8sApiExtensionsV1beta1Ingress]
  describe 'read_extensions_v1beta1_namespaced_ingress_status test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for replace_extensions_v1beta1_namespaced_ingress
  ...
  # @option opts [String] :field_manager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
  # @return [IoK8sApiExtensionsV1beta1Ingress]
  describe 'replace_extensions_v1beta1_namespaced_ingress test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for replace_extensions_v1beta1_namespaced_ingress_status
  ...
  # @option opts [String] :field_manager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
  # @return [IoK8sApiExtensionsV1beta1Ingress]
  describe 'replace_extensions_v1beta1_namespaced_ingress_status test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for watch_extensions_v1beta1_ingress_list_for_all_namespaces
  ...
  describe 'watch_extensions_v1beta1_ingress_list_for_all_namespaces test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for watch_extensions_v1beta1_namespaced_ingress
  ...
  # @option opts [Boolean] :watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
  # @return [IoK8sApimachineryPkgApisMetaV1WatchEvent]
  describe 'watch_extensions_v1beta1_namespaced_ingress test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for watch_extensions_v1beta1_namespaced_ingress_list
  # watch individual changes to a list of Ingress. deprecated: use the &#39;watch&#39; parameter with a list operation instead.
  # @param namespace object name and auth scope, such as for teams and projects
  # @param [Hash] opts the optional parameters
  # @option opts [Boolean] :allow_watch_bookmarks allowWatchBookmarks requests watch events with type \&quot;BOOKMARK\&quot;. Servers that do not implement bookmarks may ignore this flag and bookmarks are sent at the server&#39;s discretion. Clients should not assume bookmarks are returned at any specific interval, nor may they assume the server will send any BOOKMARK event during a session. If this is not a watch, this field is ignored. If the feature gate WatchBookmarks is not enabled in apiserver, this field is ignored.
  ...
  # @option opts [Boolean] :watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
  # @return [IoK8sApimachineryPkgApisMetaV1WatchEvent]
  describe 'watch_extensions_v1beta1_namespaced_ingress_list test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
