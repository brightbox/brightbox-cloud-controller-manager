...
describe 'AuthorizationV1beta1Api' do
  ...
  describe 'test an instance of AuthorizationV1beta1Api' do
    it 'should create an instance of AuthorizationV1beta1Api' do
      expect(@api_instance).to be_instance_of(Kubernetes::AuthorizationV1beta1Api)
    end
  end

  # unit tests for create_authorization_v1beta1_namespaced_local_subject_access_review
  ...
  describe 'create_authorization_v1beta1_namespaced_local_subject_access_review test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for create_authorization_v1beta1_self_subject_access_review
  ...
  describe 'create_authorization_v1beta1_self_subject_access_review test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for create_authorization_v1beta1_self_subject_rules_review
  ...
  describe 'create_authorization_v1beta1_self_subject_rules_review test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for create_authorization_v1beta1_subject_access_review
  ...
  describe 'create_authorization_v1beta1_subject_access_review test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_authorization_v1beta1_api_resources
  # get available resources
  # @param [Hash] opts the optional parameters
  # @return [IoK8sApimachineryPkgApisMetaV1APIResourceList]
  describe 'get_authorization_v1beta1_api_resources test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
