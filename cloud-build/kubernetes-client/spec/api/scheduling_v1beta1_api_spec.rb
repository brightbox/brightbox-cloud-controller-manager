...
# Unit tests for Kubernetes::SchedulingV1beta1Api
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'SchedulingV1beta1Api' do
  before do
  ...
  describe 'test an instance of SchedulingV1beta1Api' do
    it 'should create an instance of SchedulingV1beta1Api' do
      expect(@api_instance).to be_instance_of(Kubernetes::SchedulingV1beta1Api)
    end
  end

  # unit tests for create_scheduling_v1beta1_priority_class
  ...
  describe 'create_scheduling_v1beta1_priority_class test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for delete_scheduling_v1beta1_collection_priority_class
  ...
  describe 'delete_scheduling_v1beta1_collection_priority_class test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for delete_scheduling_v1beta1_priority_class
  ...
  # @option opts [IoK8sApimachineryPkgApisMetaV1DeleteOptions] :body 
  # @return [IoK8sApimachineryPkgApisMetaV1Status]
  describe 'delete_scheduling_v1beta1_priority_class test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_scheduling_v1beta1_api_resources
  # get available resources
  # @param [Hash] opts the optional parameters
  # @return [IoK8sApimachineryPkgApisMetaV1APIResourceList]
  describe 'get_scheduling_v1beta1_api_resources test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for list_scheduling_v1beta1_priority_class
  ...
  describe 'list_scheduling_v1beta1_priority_class test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for patch_scheduling_v1beta1_priority_class
  ...
  # @return [IoK8sApiSchedulingV1beta1PriorityClass]
  describe 'patch_scheduling_v1beta1_priority_class test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for read_scheduling_v1beta1_priority_class
  ...
  # @return [IoK8sApiSchedulingV1beta1PriorityClass]
  describe 'read_scheduling_v1beta1_priority_class test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for replace_scheduling_v1beta1_priority_class
  ...
  # @option opts [String] :field_manager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
  # @return [IoK8sApiSchedulingV1beta1PriorityClass]
  describe 'replace_scheduling_v1beta1_priority_class test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for watch_scheduling_v1beta1_priority_class
  ...
  describe 'watch_scheduling_v1beta1_priority_class test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for watch_scheduling_v1beta1_priority_class_list
  ...
  # @option opts [Boolean] :watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
  # @return [IoK8sApimachineryPkgApisMetaV1WatchEvent]
  describe 'watch_scheduling_v1beta1_priority_class_list test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
