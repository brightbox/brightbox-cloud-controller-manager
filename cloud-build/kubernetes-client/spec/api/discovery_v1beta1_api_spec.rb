...
# Unit tests for Kubernetes::DiscoveryV1beta1Api
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'DiscoveryV1beta1Api' do
  before do
  ...
  describe 'test an instance of DiscoveryV1beta1Api' do
    it 'should create an instance of DiscoveryV1beta1Api' do
      expect(@api_instance).to be_instance_of(Kubernetes::DiscoveryV1beta1Api)
    end
  end

  # unit tests for create_discovery_v1beta1_namespaced_endpoint_slice
  ...
  describe 'create_discovery_v1beta1_namespaced_endpoint_slice test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for delete_discovery_v1beta1_collection_namespaced_endpoint_slice
  ...
  describe 'delete_discovery_v1beta1_collection_namespaced_endpoint_slice test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for delete_discovery_v1beta1_namespaced_endpoint_slice
  ...
  # @option opts [IoK8sApimachineryPkgApisMetaV1DeleteOptions] :body 
  # @return [IoK8sApimachineryPkgApisMetaV1Status]
  describe 'delete_discovery_v1beta1_namespaced_endpoint_slice test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_discovery_v1beta1_api_resources
  # get available resources
  # @param [Hash] opts the optional parameters
  # @return [IoK8sApimachineryPkgApisMetaV1APIResourceList]
  describe 'get_discovery_v1beta1_api_resources test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for list_discovery_v1beta1_endpoint_slice_for_all_namespaces
  ...
  describe 'list_discovery_v1beta1_endpoint_slice_for_all_namespaces test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for list_discovery_v1beta1_namespaced_endpoint_slice
  # list or watch objects of kind EndpointSlice
  # @param namespace object name and auth scope, such as for teams and projects
  # @param [Hash] opts the optional parameters
  # @option opts [String] :pretty If &#39;true&#39;, then the output is pretty printed.
  ...
  # @option opts [Boolean] :watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
  # @return [IoK8sApiDiscoveryV1beta1EndpointSliceList]
  describe 'list_discovery_v1beta1_namespaced_endpoint_slice test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for patch_discovery_v1beta1_namespaced_endpoint_slice
  ...
  # @return [IoK8sApiDiscoveryV1beta1EndpointSlice]
  describe 'patch_discovery_v1beta1_namespaced_endpoint_slice test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for read_discovery_v1beta1_namespaced_endpoint_slice
  ...
  # @return [IoK8sApiDiscoveryV1beta1EndpointSlice]
  describe 'read_discovery_v1beta1_namespaced_endpoint_slice test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for replace_discovery_v1beta1_namespaced_endpoint_slice
  ...
  # @option opts [String] :field_manager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
  # @return [IoK8sApiDiscoveryV1beta1EndpointSlice]
  describe 'replace_discovery_v1beta1_namespaced_endpoint_slice test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for watch_discovery_v1beta1_endpoint_slice_list_for_all_namespaces
  ...
  describe 'watch_discovery_v1beta1_endpoint_slice_list_for_all_namespaces test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for watch_discovery_v1beta1_namespaced_endpoint_slice
  ...
  # @option opts [Boolean] :watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
  # @return [IoK8sApimachineryPkgApisMetaV1WatchEvent]
  describe 'watch_discovery_v1beta1_namespaced_endpoint_slice test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for watch_discovery_v1beta1_namespaced_endpoint_slice_list
  # watch individual changes to a list of EndpointSlice. deprecated: use the &#39;watch&#39; parameter with a list operation instead.
  # @param namespace object name and auth scope, such as for teams and projects
  # @param [Hash] opts the optional parameters
  # @option opts [Boolean] :allow_watch_bookmarks allowWatchBookmarks requests watch events with type \&quot;BOOKMARK\&quot;. Servers that do not implement bookmarks may ignore this flag and bookmarks are sent at the server&#39;s discretion. Clients should not assume bookmarks are returned at any specific interval, nor may they assume the server will send any BOOKMARK event during a session. If this is not a watch, this field is ignored. If the feature gate WatchBookmarks is not enabled in apiserver, this field is ignored.
  ...
  # @option opts [Boolean] :watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
  # @return [IoK8sApimachineryPkgApisMetaV1WatchEvent]
  describe 'watch_discovery_v1beta1_namespaced_endpoint_slice_list test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
