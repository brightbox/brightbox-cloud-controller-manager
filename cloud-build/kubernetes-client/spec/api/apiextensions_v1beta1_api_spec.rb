...
# Unit tests for Kubernetes::ApiextensionsV1beta1Api
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ApiextensionsV1beta1Api' do
  before do
  ...
  describe 'test an instance of ApiextensionsV1beta1Api' do
    it 'should create an instance of ApiextensionsV1beta1Api' do
      expect(@api_instance).to be_instance_of(Kubernetes::ApiextensionsV1beta1Api)
    end
  end

  # unit tests for create_apiextensions_v1beta1_custom_resource_definition
  ...
  describe 'create_apiextensions_v1beta1_custom_resource_definition test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for delete_apiextensions_v1beta1_collection_custom_resource_definition
  ...
  describe 'delete_apiextensions_v1beta1_collection_custom_resource_definition test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for delete_apiextensions_v1beta1_custom_resource_definition
  ...
  # @option opts [IoK8sApimachineryPkgApisMetaV1DeleteOptions] :body 
  # @return [IoK8sApimachineryPkgApisMetaV1Status]
  describe 'delete_apiextensions_v1beta1_custom_resource_definition test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_apiextensions_v1beta1_api_resources
  # get available resources
  # @param [Hash] opts the optional parameters
  # @return [IoK8sApimachineryPkgApisMetaV1APIResourceList]
  describe 'get_apiextensions_v1beta1_api_resources test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for list_apiextensions_v1beta1_custom_resource_definition
  ...
  describe 'list_apiextensions_v1beta1_custom_resource_definition test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for patch_apiextensions_v1beta1_custom_resource_definition
  ...
  # @return [IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1CustomResourceDefinition]
  describe 'patch_apiextensions_v1beta1_custom_resource_definition test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for patch_apiextensions_v1beta1_custom_resource_definition_status
  ...
  # @option opts [Boolean] :force Force is going to \&quot;force\&quot; Apply requests. It means user will re-acquire conflicting fields owned by other people. Force flag must be unset for non-apply patch requests.
  # @return [IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1CustomResourceDefinition]
  describe 'patch_apiextensions_v1beta1_custom_resource_definition_status test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for read_apiextensions_v1beta1_custom_resource_definition
  ...
  # @return [IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1CustomResourceDefinition]
  describe 'read_apiextensions_v1beta1_custom_resource_definition test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for read_apiextensions_v1beta1_custom_resource_definition_status
  # read status of the specified CustomResourceDefinition
  # @param name name of the CustomResourceDefinition
  # @param [Hash] opts the optional parameters
  # @option opts [String] :pretty If &#39;true&#39;, then the output is pretty printed.
  # @return [IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1CustomResourceDefinition]
  describe 'read_apiextensions_v1beta1_custom_resource_definition_status test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for replace_apiextensions_v1beta1_custom_resource_definition
  ...
  # @option opts [String] :field_manager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
  # @return [IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1CustomResourceDefinition]
  describe 'replace_apiextensions_v1beta1_custom_resource_definition test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for replace_apiextensions_v1beta1_custom_resource_definition_status
  ...
  # @option opts [String] :field_manager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
  # @return [IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1CustomResourceDefinition]
  describe 'replace_apiextensions_v1beta1_custom_resource_definition_status test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for watch_apiextensions_v1beta1_custom_resource_definition
  ...
  describe 'watch_apiextensions_v1beta1_custom_resource_definition test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for watch_apiextensions_v1beta1_custom_resource_definition_list
  ...
  # @option opts [Boolean] :watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
  # @return [IoK8sApimachineryPkgApisMetaV1WatchEvent]
  describe 'watch_apiextensions_v1beta1_custom_resource_definition_list test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
