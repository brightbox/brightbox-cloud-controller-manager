...
# Unit tests for Kubernetes::ApiregistrationV1beta1Api
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ApiregistrationV1beta1Api' do
  before do
  ...
  describe 'test an instance of ApiregistrationV1beta1Api' do
    it 'should create an instance of ApiregistrationV1beta1Api' do
      expect(@api_instance).to be_instance_of(Kubernetes::ApiregistrationV1beta1Api)
    end
  end

  # unit tests for create_apiregistration_v1beta1_api_service
  ...
  describe 'create_apiregistration_v1beta1_api_service test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for delete_apiregistration_v1beta1_api_service
  ...
  describe 'delete_apiregistration_v1beta1_api_service test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for delete_apiregistration_v1beta1_collection_api_service
  ...
  # @option opts [IoK8sApimachineryPkgApisMetaV1DeleteOptions] :body 
  # @return [IoK8sApimachineryPkgApisMetaV1Status]
  describe 'delete_apiregistration_v1beta1_collection_api_service test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_apiregistration_v1beta1_api_resources
  # get available resources
  # @param [Hash] opts the optional parameters
  # @return [IoK8sApimachineryPkgApisMetaV1APIResourceList]
  describe 'get_apiregistration_v1beta1_api_resources test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for list_apiregistration_v1beta1_api_service
  ...
  describe 'list_apiregistration_v1beta1_api_service test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for patch_apiregistration_v1beta1_api_service
  ...
  # @return [IoK8sKubeAggregatorPkgApisApiregistrationV1beta1APIService]
  describe 'patch_apiregistration_v1beta1_api_service test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for patch_apiregistration_v1beta1_api_service_status
  ...
  # @option opts [Boolean] :force Force is going to \&quot;force\&quot; Apply requests. It means user will re-acquire conflicting fields owned by other people. Force flag must be unset for non-apply patch requests.
  # @return [IoK8sKubeAggregatorPkgApisApiregistrationV1beta1APIService]
  describe 'patch_apiregistration_v1beta1_api_service_status test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for read_apiregistration_v1beta1_api_service
  ...
  # @return [IoK8sKubeAggregatorPkgApisApiregistrationV1beta1APIService]
  describe 'read_apiregistration_v1beta1_api_service test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for read_apiregistration_v1beta1_api_service_status
  # read status of the specified APIService
  # @param name name of the APIService
  # @param [Hash] opts the optional parameters
  # @option opts [String] :pretty If &#39;true&#39;, then the output is pretty printed.
  # @return [IoK8sKubeAggregatorPkgApisApiregistrationV1beta1APIService]
  describe 'read_apiregistration_v1beta1_api_service_status test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for replace_apiregistration_v1beta1_api_service
  ...
  # @option opts [String] :field_manager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
  # @return [IoK8sKubeAggregatorPkgApisApiregistrationV1beta1APIService]
  describe 'replace_apiregistration_v1beta1_api_service test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for replace_apiregistration_v1beta1_api_service_status
  ...
  # @option opts [String] :field_manager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
  # @return [IoK8sKubeAggregatorPkgApisApiregistrationV1beta1APIService]
  describe 'replace_apiregistration_v1beta1_api_service_status test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for watch_apiregistration_v1beta1_api_service
  ...
  describe 'watch_apiregistration_v1beta1_api_service test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for watch_apiregistration_v1beta1_api_service_list
  ...
  # @option opts [Boolean] :watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
  # @return [IoK8sApimachineryPkgApisMetaV1WatchEvent]
  describe 'watch_apiregistration_v1beta1_api_service_list test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
